...
//  object intOrd2 extends Ord[Int] {
//    override def compare(a: Int, b: Int): Boolean = a <= b
//  }
  ...
  implicit def pairOrd[T1, T2](implicit ord1: Ord[T1], ord2: Ord[T2]): Ord[(T1, T2)] = new Ord[(T1, T2)] {
    override def compare(a: (T1, T2), b: (T1, T2)): Boolean =
      if(a._1 == b._1) ord2.compare(a._2, b._2) else ord1.compare(a._1, b._1)
  }
